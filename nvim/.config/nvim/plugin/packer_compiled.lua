...
_G.packer_plugins = {
  ...
  ["nvim-lspconfig"] = {
    config = { "\27LJ\2\n.\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\19jvg.config.lsp\frequire\0" },
    loaded = true,
  ...
  ["vim-codepainter"] = {
    ...
    loaded = true,
    path = "/Users/justinvangrootveld/.local/share/nvim/site/pack/packer/start/vim-codepainter"
  },
  ["vim-commentary"] = {
    loaded = true,
...
try_loadstring("\27LJ\2\n.\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\19jvg.config.lsp\frequire\0", "config", "nvim-lspconfig")
...
time([[Config for vim-codepainter]], true)
require("jvg.config.vim-codepainter")
time([[Config for vim-codepainter]], false)
-- Config for: gruvbox
