-- Copied from TJ: https://github.com/tjdevries/config_manager/blob/master/xdg_config/nvim/lua/tj/globals/opt.lua
-- This file can be removed till this is merged: 
--
